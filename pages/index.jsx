...
I am a professional editor and software developer. I have been professionally interested in community management and development for 2 years, I have high level knowledge and experience in areas such as community management.
                </p>
              </div>
              <div className={`order-first lg:order-last flex-shrink-0 relative w-[160px] h-[160px] rounded-full pulse-avatar-online `}>
                <img alt="QWertx" src={`https://media.discordapp.net/attachments.`} width="160" height="160" className={`bg-neutral-700 w-[160px] h-[160px] rounded-full`} />
